  ...
  switch (Serial.read())
  {
    ...
    case 0x42: //16BPP RGB FRAME
      ...
      for (int i = 0; i < 320 * 240; i++)
        usingFB1 ? fb2[i] = sBuf[i * 2] << 8 | sBuf[i * 2 + 1]  : fb1[i] = sBuf[i * 2] << 8 | sBuf[i * 2 + 1];
      usingFB1 = !usingFB1;
    ...
    case 0x43: // 8BPP RGB FRAME
      ...
      for (int i = 0; i < 320 * 240; i++)
        usingFB1 ? fb2[i] = ((sBuf[i] & B11100000) << 8) | ((sBuf[i] & B00011100) << 6) | ((sBuf[i] & B00000011) << 3) :
    ...
    case 0x44: // 8BPP GREYSCALE FRAME
      ...
      for (int i = 0; i < 320 * 240; i++)
        usingFB1 ? fb2[i] = ((sBuf[i] & B11111000) << 8) | ((sBuf[i] & B11111100) << 3) | ((sBuf[i] & B11111000) >> 3) :
